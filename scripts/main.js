...
const CLEFAPI ='24fd91c0a7bfccb8c531749f9e4e8a69';
let resultatsAPI;
...
if(navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(position => {
        ...
        alert(`Si vous refusez la géolocalisation, l'application ne peur pas fonctionner, veuillez l'activer.!`)
    })
}
